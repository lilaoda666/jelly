...
public abstract class AbsObserver<T> implements Observer<T> {
    ...
    public AbsObserver(boolean isShowToast) {
        this.isShowToast = isShowToast;
    }

    public AbsObserver(String dialogMsg) {
        mDialogMsg = dialogMsg;
        this.isShowDialog = true;
    }

    public AbsObserver(String dialogMsg, boolean isShowToast) {
        this.isShowToast = isShowToast;
    ...
    private void showDialog() {
        ...
        mLoadingDialog.show();
        mLoadingDialog.setMsg(mDialogMsg);
    }
